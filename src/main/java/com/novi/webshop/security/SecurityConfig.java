...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET,"/orderhistory/customerid={id}").hasAnyAuthority("ADMIN", "EMPLOYEE", "CUSTOMER")
                ...
                .antMatchers(HttpMethod.PUT,"/order/change-returns-processed-status={processed}/id={id}").hasAuthority("ADMIN")
                ...
                .antMatchers(HttpMethod.PUT,"/returns/id={returnCartId}/productid={productId}").permitAll()
                ...
                .antMatchers(HttpMethod.PUT,"/employee/id={employeeId}/returns-id={orderId}").hasAuthority("ADMIN")
